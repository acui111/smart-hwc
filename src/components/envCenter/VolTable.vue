...
<script type="text/ecmascript-6">
  ...
  export default {
    mounted(){
      // 沙盘导播坐席(1)的主屏拖拽
      interact(this.$refs["vol-screen-home1"])
      .draggable({
        modifiers: [
      ...
      .on("move", (ev) => {
        if (ev.interaction.pointerIsDown && !ev.interaction.interacting()) {
          const leftSeat = this.$editor.configs.seatList[4];
      ...
      // 沙盘导播坐席(1)的副屏拖拽
      interact(this.$refs["vol-screen-vice1"])
      .draggable({
        modifiers: [
          interact.modifiers.restrictRect({
            restriction: "parent",
      ...
      // 沙盘导播坐席(2)的主屏拖拽
      interact(this.$refs["vol-screen-home2"])
      .draggable({
        modifiers: [
          interact.modifiers.restrictRect({
            restriction: "parent",
      ...
      // 沙盘导播坐席(2)的副屏拖拽
      interact(this.$refs["vol-screen-vice2"])
      .draggable({
        modifiers: [
          interact.modifiers.restrictRect({
            restriction: "parent",
